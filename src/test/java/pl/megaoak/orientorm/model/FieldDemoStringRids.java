...
public class FieldDemoStringRids {
	@ID
	private String id;
	...
	private Map<String, String> linkMapField;
	private Set<String> linkSetField;
	...
	public List<String> getLinkListField() {
		return linkListField;
	}

	public void setLinkListField(List<String> linkListField) {
		this.linkListField = linkListField;
	}

	public Map<String, String> getLinkMapField() {
		return linkMapField;
	}

	public void setLinkMapField(Map<String, String> linkMapField) {
		this.linkMapField = linkMapField;
	}

	public Set<String> getLinkSetField() {
		return linkSetField;
	}

	public void setLinkSetField(Set<String> linkSetField) {
